...
public class PartUtilsImpl {
  ...
  public static GameObject GetIconPrefab(
  ...
  /// </param>
  /// <returns>The model of the part. Don't forget to destroy it when not needed.</returns>
  public static GameObject GetPartModel(
      AvailablePart avPart,
    ...
    if (partNode != null) {
      var scale = PartNodeUtilsImpl.GetTweakScaleSizeModifier(partNode);
  ...
  /// needed anymore.
  /// </returns>
  public static GameObject GetSceneAssemblyModel(Part rootPart, bool goThruChildren = true, bool keepColliders = false) {
  ...
  public static double GetPartVolume(
    ...
    //      * PartNodeUtils.GetTweakScaleSizeModifier(partNode);  // But respect TweakScale.
    //}
    Vector3 boundsSize = GetPartBounds(avPart, variant: variant, partNode: partNode);
  ...
  /// <returns>The volume in liters.</returns>
  public static double GetPartVolume(Part part) {
    var partNode = PartNodeUtilsImpl.PartSnapshot(part);
  ...
  /// </param>
  /// <returns>The volume in liters.</returns>
  public static Vector3 GetPartBounds(
      AvailablePart avPart, PartVariant variant = null, ConfigNode partNode = null) {
  ...
  public static double GetPartDryMass(
      AvailablePart avPart, PartVariant variant = null, ConfigNode partNode = null) {
  ...
  /// </param>
  /// <returns>The dry cost of the part.</returns>
  public static double GetPartDryCost(
      AvailablePart avPart, PartVariant variant = null, ConfigNode partNode = null) {
    // TweakScale compatibility
    if (partNode != null) {
      ConfigNode tweakScale = PartNodeUtilsImpl.GetTweakScaleModule(partNode);
      if (tweakScale != null) {
        double? tweakedCost = ConfigAccessor.GetValueByPath<double>(tweakScale, "DryCost");
  ...
  public static void CollectMeshesFromModel(Transform model,
