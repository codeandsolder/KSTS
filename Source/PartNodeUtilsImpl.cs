...
public class PartNodeUtilsImpl {
  ...
  public static ConfigNode GetTweakScaleModule(ConfigNode partNode) {
    ...
    ConfigNode[] tweakScaleNodes = NodeUtil.GetModuleNodesNamed(partNode, "TweakScale");
    return tweakScaleNodes != null && tweakScaleNodes.Length > 0 ? tweakScaleNodes[0] : null;   
  }
